...
constexpr Texture texture = Texture::T_Time_bg;

TimeBG::TimeBG(Scene* parent) : Entity(parent)
{
	auto model = ModelImport::UIData(Window::GetWidth<float>() / 2 - 400 / 2, 0, 400, 80, 0, 0, 1, 1);
...
void TimeBG::Draw(RenderingPass pass)
{
