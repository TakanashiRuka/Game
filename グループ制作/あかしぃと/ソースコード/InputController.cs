...
public static class InputController
{
    ...
    public static void SetDefault()
    {
        ...
        controller.Axes[Axis.Cross_Horizontal].SetAxisName("Cont");
        controller.Axes[Axis.Cross_Vertical].SetAxisName("vCont");
    ...
    public static void SetForKeyboard()
    {
        ...
        controller.Buttons[Button.B].SetKeyCode(KeyCode.Return);
        controller.Buttons[Button.X].SetKeyCode(KeyCode.X);
        controller.Buttons[Button.Y].SetKeyCode(KeyCode.C);

        controller.Buttons[Button.Start].SetKeyCode(KeyCode.Z);
        ...
        controller.Axes[Axis.L_Horizontal].SetKeyCodes(KeyCode.RightArrow, KeyCode.LeftArrow);
        controller.Axes[Axis.L_Vertical].SetKeyCodes(KeyCode.W, KeyCode.S);
        controller.Axes[Axis.Cross_Horizontal].SetKeyCodes(KeyCode.D, KeyCode.A);
